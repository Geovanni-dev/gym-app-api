...
// HISTÓRICO DE TREINOS (CORRIGIDO)
exports.getWorkoutHistory = async (req, res) => {

  try {

    // CORREÇÃO: Busca do WorkoutHistory em vez do Workout
...
// CALCULAR PR (PERSONAL RECORD) (CORRIGIDO)
exports.getPR = async (req, res) => {
  ...
  try {
    ...
    workouts.forEach(workout => {
      ...
      // CORREÇÃO: Acessa exerciseName diretamente (não tem array exercises)
...
// REGISTRAR TREINO EXECUTADO (CORRIGIDO)
exports.logWorkout = async (req, res) => {
  ...
  try {
    ...
    // CORREÇÃO: Criar registros no WorkoutHistory
